...
import { solveStar1, solveStar2 } from "./day14";
...
describe("Day " + DAY, () => {
  it("should pass test", () => {
    expect(solveStar1(testInput)).toBe(136);
  });

  it("should solve star 1", () => {
    expect(solveStar1(input)).toBe(109596);
  });

  it("should pass test star 2", () => {
    expect(solveStar2(testInput)).toBe(64);
  });

  it("should solve star 2", () => {
    expect(solveStar2(input)).toBe(96105);
  });
});
